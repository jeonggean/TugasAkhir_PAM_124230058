...
class _DetailedProfileScreenState extends State<DetailedProfileScreen> {
  ...
  Future<void> _confirmRemoveFriend() async {
    final confirm = await showDialog<bool>(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Text("Apakah Anda yakin ingin menghapus $_displayUsername dari daftar teman?"),
        actions: [
      ...
      child: Scaffold(
        ...
        body: Column(
          children: [
                      ...
                      child: Row(
                        children: [
                          Container(
                            ...
                            child: const CircleAvatar(radius: 40, backgroundColor: Colors.white, child: Icon(Icons.person, size: 40, color: Colors.grey)),
                          ),
                            ...
                            child: Column(
                              ...
                              children: [
                                RichText(
                                  text: TextSpan(
                                    children: [
                                      TextSpan(text: _displayUsername, style: GoogleFonts.nunito(fontSize: 22, fontWeight: FontWeight.bold, color: Colors.white)),
                                      if (_isMe)
                                        TextSpan(text: " (You)", style: GoogleFonts.nunito(fontSize: 14, fontWeight: FontWeight.normal, color: Colors.white70, fontStyle: FontStyle.italic)),
                                    ],
                                  ),
                                ),
                                ...
                                Container(
                                  ...
                                  child: Text(_badgeHelper.getBadgeName(), style: GoogleFonts.nunito(fontSize: 12, color: Colors.white, fontWeight: FontWeight.bold)),
                                ),
                      ...
                      Padding(
                        ...
                        child: SizedBox(
                          ...
                          child: ElevatedButton.icon(
                            ...
                            label: const Text("Buat Postingan Baru", style: TextStyle(color: AppColors.kPrimaryColor, fontWeight: FontWeight.bold)),
                            style: ElevatedButton.styleFrom(backgroundColor: Colors.white, shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12)), padding: const EdgeInsets.symmetric(vertical: 12)),
                          ),
                        ),
                      )
                    else
                      Padding(
                        ...
                        child: SizedBox(
                          ...
                          child: ElevatedButton.icon(
                            ...
                            label: const Text("Hapus Teman", style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
            ...
            Expanded(child: ProfileContentTab(userId: _isMe ? null : _currentUserId)),
          ],
        ),
      ),
    );
  ...
  Widget _statItem(String label, int value) {
    return Column(
      ...
      children: [
        Text(value.toString(), style: GoogleFonts.nunito(fontWeight: FontWeight.bold, fontSize: 18, color: Colors.white)),
